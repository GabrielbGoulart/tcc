...
now = parse("2022-01-14 14:10:24.470174+00:00")
...
def save_price(prices,time,file):
...
for day in range(1,30):
    with open('1_month.csv', 'w') as f:
        a="""#group,false,false,false,false,true,true,true,
#datatype,string,long,dateTime:RFC3339,double,string,string,string
#default,_result,,,,,,
,result,table,_time,_value,_field,_measurement,bond
        """
        f.write(a)
        for sec in range(24):
            w_str = ""
            for sec in range(1,3600):
                ...
                for bond,price_value in prices:
                    w_str+=f",,0,{generate(insert_time)},{round(price_value,2)},value,price,{bond};\n"
            print(datetime.datetime.now())
            f.write(w_str)
            print(datetime.datetime.now(),insert_time)
    os.remove("1_month.csv")
    print('removed')